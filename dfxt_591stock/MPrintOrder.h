...
__published:	// IDE-managed Components
	...
	void __fastcall OrderTypeKeyDown(TObject *Sender, WORD &Key, TShiftState Shift);
...
public:		// User declarations
	AnsiString temp_customer_name;
	AnsiString temp_store_name;
	AnsiString temp_order_type;
